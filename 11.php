<h1>Метод Цезаря с ключевым словом (расшифровка)</h1>
...
// Шифруем и выводим
decryption($text, $alphabet, $decodingAlphabet);
...
function decryption($text,$decodingAlphabet , $alphabet){
    ...
    echo "Расшифрованный текст: " . $text . "<br>";
}
